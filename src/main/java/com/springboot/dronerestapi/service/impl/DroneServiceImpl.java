...
public class DroneServiceImpl implements DroneService {
    ...
    public DroneResponseDto createDrone(DroneRequestDto requestDto) {
        ...
        DroneResponseDto responseDto=Mapper.mapToDto(drone1);
        return  responseDto;
    }
    ...
    public MedicationResponseDto loadDrone(MedicationRequestDto requestDto, String id) {
        ...
        MedicationResponseDto medicationResponseDto=Mapper.mapToDto(medication1);
    ...
    @Override
    public DroneBatteryResponse checkDroneBatteryLevel(String id) {
        Drone drone=droneRepository.findById(id).orElseThrow(()-> new DroneNotFoundException("Drone with id not found"));

        DroneBatteryResponse droneBatteryResponse = new DroneBatteryResponse();
        droneBatteryResponse.setBattery(drone.getBattery());
