...
class DroneServiceImplTest {
    ...
    @InjectMocks
    //this allows to inject mock objects
...
//    @Test
//    void loadMedicationImage(){
//        Mockito.when(medicationRepository.findById(MED_ID)).thenReturn(Optional.ofNullable(medication));
//        Mockito.when(medicationRepository.save(medication)).thenReturn(medication);
//        droneService.uploadMedicationImage(Mapper.compressImage())
//    }
    ...
    void checkDroneBatteryLevel() {
        Mockito.when(droneRepository.findById(DUMMY_ID)).thenReturn(Optional.ofNullable(drone));
        DroneBatteryResponse droneBatteryResponse =droneService.checkDroneBatteryLevel(DUMMY_ID);
        assertEquals(drone.getBattery(), droneBatteryResponse.getBattery());
    }
}